...
--16. Using the Employees and Departments tables, write a query to
-- return employees from the 'Sales' department whose salary is above 60000.
-- 🔁 Expected Columns: EmployeeName, Salary, DepartmentName
SELECT 
	E.Name AS EmployeeName,
	E.Salary,
...
--23. Using the Employees and Departments tables, write a query to return employees 
-- who work in departments which name starts with the letter 'M'.
-- 🔁 Expected Columns: EmployeeName, DepartmentName
SELECT 
	E.Name AS EmployeeName,
	D.DepartmentName
